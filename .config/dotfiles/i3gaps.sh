...
yes | sudo apt install libxcb1-dev libxcb-keysyms1-dev libpango1.0-dev \
    ...
    libxkbcommon-x11-dev xutils-dev libxcb-shape0-dev autoconf automake \
    libtool
